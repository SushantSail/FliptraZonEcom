  ...
  return (
    <>
      <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="px-5 pb-5">
          <Link to={`/product/${id}`} state={{ image: itemImage }}>
          ...
          <div class="flex items-center justify-between">
            ...
            (<button
              ...
              class="text-white bg-red-600 hover:g-red-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
            >
             Remove
            </button>)
            :(
